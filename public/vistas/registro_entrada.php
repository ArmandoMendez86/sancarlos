...
<head>
    ...
    <style>
        ...
        .nav-tabs .nav-link {
            color: #bdc3c7; /* Texto claro para pestañas inactivas */
            border: none;
            border-radius: 8px 8px 0 0;
            background-color: #34495e; /* Fondo oscuro para pestañas inactivas */
            margin-right: 2px;
        }
        .nav-tabs .nav-link.active {
            color: #fff;
            background-color: #0d6efd; /* Color vibrante para la pestaña activa */
        }
        .tab-content {
            background-color: #fff; /* Contenido con fondo blanco */
            color: #2c3e50;
            padding: 20px;
                    ...
                    <div class="card-header p-0" style="border-bottom: none;">
                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="entrada-tab" data-bs-toggle="tab" data-bs-target="#entrada-pane" type="button" role="tab" aria-controls="entrada-pane" aria-selected="true">Entrada de Vehículo</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="salida-tab" data-bs-toggle="tab" data-bs-target="#salida-pane" type="button" role="tab" aria-controls="salida-pane" aria-selected="false">Salida y Cobro</button>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="entrada-pane" role="tabpanel" aria-labelledby="entrada-tab" tabindex="0">
                            <form action="#" method="post" class="p-4">
                                <div class="mb-3">
                                    <label for="licensePlate" class="form-label">Placa del vehículo</label>
                                    <input type="text" class="form-control" id="licensePlate" placeholder="Ej. ABC-123" required>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="brand" placeholder="Ej. Toyota" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="salida-pane" role="tabpanel" aria-labelledby="salida-tab" tabindex="0">
                            <form action="#" method="post" class="p-4">
                                <div class="mb-4">
                                    <label for="licensePlateSearch" class="form-label">Buscar vehículo por placa</label>
                                    <div class="search-container">
                                        <input type="text" class="form-control" id="licensePlateSearch" placeholder="Ej. ABC-123" required>
                                ...
                                <div id="vehicle-details" style="display: none;">
                                    <div class="alert alert-light text-center" role="alert">
                                        ...
                                        <hr>
                                        <h5 class="mt-3 text-dark">Tiempo total: <span class="text-primary fw-bold">2 horas y 30 minutos</span></h5>
                                        <h4 class="my-4 text-dark">Costo total: <span class="text-success fw-bold">$50.00</span></h4>
                                    </div>
